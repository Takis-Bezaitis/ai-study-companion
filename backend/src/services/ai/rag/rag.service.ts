...
export class RAGService {
  ...
  `.trim();
    ...
    return {
      sources: chunks,
      stream: aiService.streamText({
        prompt,
      }),
    };
  }

  private async *createFallbackStream(): AsyncIterable<string> {
    yield "I couldn't find relevant information in this lesson to answer the question.";
  }
}
